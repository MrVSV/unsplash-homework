...
class PhotosPagingAdapter(/*private val onClick: (Character) -> Unit*/) :
...
class PhotoViewHolder(val binding: PhotoViewHolderBinding) : RecyclerView.ViewHolder(binding.root)
